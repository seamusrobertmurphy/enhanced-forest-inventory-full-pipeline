...
```{r eval=FALSE, echo=TRUE, error=FALSE, fig.show="hold", message=FALSE, warning=FALSE, cache=TRUE, out.width="50%", cache=TRUE}
...
vri_species_aoi =  dplyr::filter(vri_species, SPEC_CD_1=='BL' | SPEC_CD_1=='FD' |SPEC_CD_1=='FDI' | SPEC_CD_1=='PL' | SPEC_CD_1=='PLI' | SPEC_CD_1=='SE' | SPEC_CD_1=='SW' | SPEC_CD_1=='SX')
...
raster_template = rast(ext(aoi_sf), resolution = 1, crs = st_crs(vri_sf)$wkt)
...
# note that new pipeline adopted below: see individual tree detection section
...
tunedModel_svm_m2_test_MAE =  caret::MAE(tunedModel_svm_m2_test, y_test_m2)
tunedModel_svm_m2_test_RMSE = caret::RMSE(tunedModel_svm_m2_test, y_test_m2)
tunedModel_svm_m2_full_MAE = caret::MAE(tunedModel_svm_m2, y_m2)
tunedModel_svm_m2_full_RMSE = caret::RMSE(tunedModel_svm_m2, y_m2)
