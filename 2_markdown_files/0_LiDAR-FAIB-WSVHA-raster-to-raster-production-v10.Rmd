---
title: "WSVHA Revisions (New Approved Masks and VRI added)"
author: "Cabin-GIS"
date: "28/06/2022"
output: 
  pdf_document:
...
The following report includes revisions to WSVHA outptus for Quesnel Lake and other All-Species Areas Fd-stands and nonFd-stands derived with newly approved masking and VRI data layers shared by LQ.

## 1. Quesnel Lake: Includes areas for all species (Fd and non-Fd stands), and developed cutblocks for validation purposes 
...
### 1.2. Quesnel Lake: Derive Terrain Rasters
...
### 1.3. Quesnel Lake: Derive Species Raster
...
### 1.7. Quesnel Lake: Bootstrapping and training/test splits 
...
### 1.8. Quesnel Lake: Modeling WSVHA Estimates with Random Forest Regression 
...
## 2. All-Species Areas: Includes Fd and non-Fd stands

### 2.1. All-Species Areas: Import DEM and CHM
...
writeRaster(lead_htop_rast_hawks_creek, filename = "/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/hawks_creek/lead_htop_raster_100m_dash.tif", overwrite=TRUE)
...
elev_raster_allSpeciesAreas_list = list(
  ...
  elev_raster_punky_clisbako, elev_raster_quesnel)
...
writeRaster(elev_raster_allSpeciesAreas, filename = "/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/elev_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
elev_raster_allSpeciesAreas = raster::raster("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/elev_raster_100m_allSpeciesAreas_20220709.tif")
...
lead_htop_raster_allSpeciesAreas_list = list(
  ...
  lead_htop_raster_phillips_anahim_lake, lead_htop_raster_piltz, 
  lead_htop_raster_punky_clisbako, lead_htop_raster_quesnel)
...
writeRaster(lead_htop_raster_allSpeciesAreas, filename = "/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/lead_htop_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
lead_htop_raster_allSpeciesAreas = raster::raster("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/lead_htop_raster_100m_allSpeciesAreas_20220709.tif")
```

```{r, fig.show='hold', out.width="50%", echo=FALSE}
elev_rast_allSpeciesAreas = terra::rast("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/elev_raster_100m_allSpeciesAreas_20220709.tif")
lead_htop_rast_allSpeciesAreas = terra::rast("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/lead_htop_raster_100m_allSpeciesAreas_20220709.tif")
terra::plot(elev_rast_allSpeciesAreas)
terra::plot(lead_htop_rast_allSpeciesAreas)
```

### 2.2. All-Species Areas: Derive Terrain Rasters
...
writeRaster(elev_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/elev_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
writeRaster(slope_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/slope_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
writeRaster(asp_cos_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_cos_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
writeRaster(asp_sin_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
writeRaster(lead_htop_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas_20220709.tif", overwrite=TRUE)
```

```{r, fig.show='hold', out.width="33%", echo=FALSE}
elev_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/elev_raster_100m_allSpeciesAreas_20220709.tif")
lead_htop_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas_20220709.tif")
slope_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/slope_raster_100m_allSpeciesAreas_20220709.tif")
asp_cos_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_cos_raster_100m_allSpeciesAreas_20220709.tif")
asp_sin_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas_20220709.tif")
terra::plot(elev_rast_allSpeciesAreas)
...
### 2.3. All-Species Areas: Derive Species Raster
...
### 2.4. All-Species Areas: Derive Mask From Approved Layers & Extents
...
### 2.5. All-Species Areas: Apply Masking
...
writeRaster(lead_htop_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/lead_htop_rast_allSpeciesAreas_masked_20220709.tif", overwrite=TRUE)
writeRaster(elev_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/elev_rast_allSpeciesAreas_masked_20220709.tif", overwrite=TRUE)
writeRaster(slope_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/slope_rast_allSpeciesAreas_masked_20220709.tif", overwrite=TRUE)
writeRaster(asp_cos_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_cos_rast_allSpeciesAreas_masked_20220709.tif", overwrite=TRUE)
writeRaster(asp_sin_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_sin_rast_allSpeciesAreas_masked_20220709.tif", overwrite=TRUE)
writeRaster(species_class_raster_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/species_class_rast_allSpeciesAreas_masked_20220709.tif", overwrite=TRUE)
```

```{r, fig.show='hold', out.width="33%", echo=FALSE}
lead_htop_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/lead_htop_rast_allSpeciesAreas_masked_20220709.tif")
elev_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/elev_rast_allSpeciesAreas_masked_20220709.tif")
slope_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/slope_rast_allSpeciesAreas_masked_20220709.tif")
asp_cos_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_cos_rast_allSpeciesAreas_masked_20220709.tif")
asp_sin_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_sin_rast_allSpeciesAreas_masked_20220709.tif")
species_class_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/species_class_rast_allSpeciesAreas_masked_20220709.tif")
```

### 2.6. All-Species Areas: Stack and Tidy Covariates
...
### 2.7. All-Species Areas: Modeling WSVHA Estimates with Random Forest Regression
...
writeRaster(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, overwrite=TRUE,
  filename = "/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas_20220709.tif")
...
```{r, fig.show='hold', out.width="50%", echo=FALSE}
wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas_20220709.tif")
plot(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, main="WSVHA for all-Species Operating Areas: Random Forest", cex.main=0.8, maxpixels=22000000)
hist(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, main="WSVHA for all-Species Operating Areas: Random Forest", cex.main=0.8, maxpixels=22000000) 
```

## 3. Non-Fd Filtered Areas: Gaspard, Hawks Creek, and Meldrum Filtered by <50% Fd 

### 3.1. Non-Fd Areas: Import DEM and CHM
...
# Merge mosaics
elev_raster_nonFdAreas_list = list(elev_raster_gaspard, elev_raster_hawks_creek, elev_raster_meldrum)
elev_raster_nonFdAreas = do.call(merge, c(elev_raster_nonFdAreas_list, tolerance = 1))
...
lead_htop_raster_nonFdAreas_list = list(lead_htop_raster_gaspard, lead_htop_raster_hawks_creek, lead_htop_raster_meldrum)
lead_htop_raster_nonFdAreas = do.call(merge, c(lead_htop_raster_nonFdAreas_list, tolerance = 1))
lead_htop_rast_nonFdAreas = terra::rast(lead_htop_raster_nonFdAreas)
writeRaster(lead_htop_raster_nonFdAreas, filename = "/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/elevlead_htop_raster_100m_nonFdAreas.tif", overwrite=TRUE)
```
