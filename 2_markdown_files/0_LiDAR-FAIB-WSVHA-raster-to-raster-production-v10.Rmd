---
title: "WSVHA Revisions (With CHM Aggregated using MAX function)"
author: "Cabin-GIS"
date: "15/07/2022 (vV)"
output: 
  pdf_document:
...
lead_htop_rast_ahbau = terra::aggregate(lead_htop_rast_ahbau, fact = 100, fun = max)
...
lead_htop_rast_bells = terra::aggregate(lead_htop_rast_bells, fact = 100, fun = max)
...
lead_htop_rast_big_valley = terra::aggregate(lead_htop_rast_big_valley, fact = 100, fun = max)
...
lead_htop_rast_cariboo_lake = terra::aggregate(lead_htop_rast_cariboo_lake, fact = 100, fun = max)
...
lead_htop_rast_charleson_marvincreek = terra::aggregate(lead_htop_rast_charleson_marvincreek, fact = 100, fun = max)
...
lead_htop_rast_dash = terra::aggregate(lead_htop_rast_dash, fact = 100, fun = max)
...
lead_htop_rast_gaspard = terra::aggregate(lead_htop_rast_gaspard, fact = 100, fun = max)
...
lead_htop_rast_hawks_creek = terra::aggregate(lead_htop_rast_hawks_creek, fact = 100, fun = max)
...
lead_htop_rast_hawks_creek2 = terra::aggregate(lead_htop_rast_hawks_creek2, fact = 100, fun = max)
...
lead_htop_rast_little_river = terra::aggregate(lead_htop_rast_little_river, fact = 100, fun = max)
...
lead_htop_rast_little_swift = terra::aggregate(lead_htop_rast_little_swift, fact = 100, fun = max)
...
lead_htop_rast_mcintosh = terra::aggregate(lead_htop_rast_mcintosh, fact = 100, fun = max)
...
lead_htop_rast_meldrum = terra::rast(lead_htop_raster_meldrum)
terra::crs(lead_htop_rast_meldrum) = "epsg:3005"
lead_htop_rast_meldrum = terra::aggregate(lead_htop_rast_meldrum, fact = 100, fun = max)
...
lead_htop_rast_phillips_anahim_lake = terra::aggregate(lead_htop_rast_phillips_anahim_lake, fact = 100, fun = max)
...
lead_htop_rast_piltz = terra::aggregate(lead_htop_rast_piltz, fact = 100, fun = max)
...
lead_htop_rast_punky_clisbako = terra::aggregate(lead_htop_rast_punky_clisbako, fact = 100, fun = max)
...
lead_htop_rast_quesnel = terra::aggregate(lead_htop_rast_quesnel, fact = 100, fun = max)
...
elev_rast_allSpeciesAreas = terra::rast("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/elev_raster_100m_allSpeciesAreas_20220712vQ.tif")
lead_htop_rast_allSpeciesAreas = terra::rast("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/lead_htop_raster_100m_allSpeciesAreas_20220715vV.tif")
...
elev_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/elev_raster_100m_allSpeciesAreas_20220712vQ.tif")
lead_htop_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/lead_htop_raster_100m_allSpeciesAreas_20220715vV.tif")
slope_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/slope_raster_100m_allSpeciesAreas_20220712vQ.tif")
asp_cos_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_cos_raster_100m_allSpeciesAreas_20220712vQ.tif")
asp_sin_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas_20220712vQ.tif")
terra::plot(elev_rast_allSpeciesAreas)
...
```{r, fig.show='hold', out.width="33%", echo=FALSE}
lead_htop_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/lead_htop_rast_allSpeciesAreas_masked_20220715vV.tif")
elev_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/elev_rast_allSpeciesAreas_masked_20220712vQ.tif")
slope_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/slope_rast_allSpeciesAreas_masked_20220712vQ.tif")
asp_cos_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_cos_rast_allSpeciesAreas_masked_20220712vQ.tif")
asp_sin_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_sin_rast_allSpeciesAreas_masked_20220712vQ.tif")
species_class_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/species_class_rast_allSpeciesAreas_masked_20220712vQ.tif")
```
...
save(tunedModel_rf_m1_full, file = "/media/seamus/128GB_WORKD/data/models/tcc-wsvha/wsvha_model1_randomForest_bootstrapped_demBased_allAreas_20220715vV.RData")
...
writeRaster(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, overwrite=TRUE,
  filename = "/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas_20220715vV.tif")
...
```{r, fig.show='hold', out.width="50%", echo=FALSE}
wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas_20220715vV.tif")
plot(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, main="WSVHA for all-Species Operating Areas: Random Forest", cex.main=0.8, maxpixels=22000000)
hist(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, main="WSVHA for all-Species Operating Areas: Random Forest", cex.main=0.8, maxpixels=22000000) 
```
