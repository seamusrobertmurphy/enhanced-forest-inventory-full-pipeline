...
species_class_rast = terra::rasterize(terra::vect(vri_species_aoi), lead_htop_rast, field = "species_class", touches = TRUE)
species_class_raster = raster::raster(species_class_rast)
writeRaster(species_class_raster, filename = "./data_quesnel/covariates/species_class_raster.tif", overwrite=TRUE)
species_class_raster = raster::raster("./data_quesnel/covariates/species_class_raster.tif")
...
writeRaster(elev_rast, filename = "./data_quesnel/covariates/elev_raster.tif", overwrite=TRUE)
writeRaster(slope_rast, filename = "./data_quesnel/covariates/slope_raster.tif", overwrite=TRUE)
writeRaster(asp_cos_rast, filename = "./data_quesnel/covariates/asp_cos_raster.tif", overwrite=TRUE)
writeRaster(asp_sin_rast, filename = "./data_quesnel/covariates/asp_sin_raster.tif", overwrite=TRUE)
writeRaster(species_class_rast, filename = "./data_quesnel/covariates/species_class_raster.tif", overwrite=TRUE)
