...
filez_vh_quesnel = list.files(
  unzip_dir_vh_quesnel,
  full.names = T,
  all.files = FALSE,
  pattern = '.tif$') 

filez_be_quesnel = list.files(
  unzip_dir_be_quesnel,
  full.names = T,
  all.files = FALSE,
  pattern = '.tif$') 

filez_vh_gaspard = list.files(
  unzip_dir_vh_gaspard,
  full.names = T,
  all.files = FALSE,
  pattern = '.tif$') 

filez_be_gaspard = list.files(
  unzip_dir_be_gaspard,
  full.names = T,
  all.files = FALSE,
  pattern = '.tif$') 
...
writeRaster(stemsha_L_rast_20cell_quesnel, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/masked-covariates/stemsha_L_raster_20cell_quesnel.tif", overwrite=TRUE)
writeRaster(stemsha_L_rast_20cell_gaspard, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/masked-covariates/stemsha_L_raster_20cell_gaspard.tif", overwrite=TRUE)
writeRaster(lead_htop_rast_20cell_quesnel, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/masked-covariates/lead_htop_raster_20cell_quesnel.tif", overwrite=TRUE)
writeRaster(lead_htop_rast_20cell_gaspard, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/masked-covariates/lead_htop_raster_20cell_gaspard.tif", overwrite=TRUE)
```
