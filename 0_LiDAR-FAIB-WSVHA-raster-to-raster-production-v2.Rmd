...
terra::plot(lead_htop_raster_gaspard)
...
vri_species_aoi_gaspard$SPECIES__1 = dplyr::recode(
  vri_species_aoi_gaspard$SPECIES__1, 
  PL = 0, PLI = 0, SB = 1, SE = 1, SW = 1, SX = 1, 
  FD = 2, FDI = 2, CW = 3, HW = 4, BL = 5, LW = 6)
...
stemsha_L_raster_df = na.omit(stemsha_L_raster_df)
dist.fun = approxfun(density(stemsha_L_raster_df$layer))
faib_psp = sample_n(faib_psp, 1102, weight_by = dist.fun(faib_psp$stemsha_L), replace = T)          
