...
lead_htop_rast_quesnel = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_quesnel.tif")
...
writeRaster(wsvha_model1_randomForest_bootstrapped_demBased_100m_quesnelANDdevBlocks, overwrite=TRUE,
  filename = "/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_quesnelANDdevBlocks_20220628.tif")
...
```{r, fig.show='hold', out.width="50%", echo=FALSE}
wsvha_model1_randomForest_bootstrapped_demBased_100m_quesnelANDdevBlocks = raster::raster("/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_quesnelANDdevBlocks_20220628.tif")
plot(wsvha_model1_randomForest_bootstrapped_demBased_100m_quesnelANDdevBlocks, main="Quesnel WSVHA: Random Forest", cex.main=0.8, maxpixels=22000000)
hist(wsvha_model1_randomForest_bootstrapped_demBased_100m_quesnelANDdevBlocks, main="Quesnel WSVHA: Random Forest", cex.main=0.8, maxpixels=22000000) 
```
...
lead_htop_raster_allSpeciesAreas_list = list(
  ...
  lead_htop_raster_little_river, lead_htop_raster_little_swift, 
  lead_htop_raster_mcintosh, lead_htop_raster_phillips_anahim_lake,
...
writeRaster(lead_htop_raster_allSpeciesAreas, filename = "/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/lead_htop_raster_100m_allSpeciesAreas.tif", overwrite=TRUE)
```

```{r, fig.show='hold', out.width="50%", echo=FALSE}
elev_rast_allSpeciesAreas = terra::rast("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/elev_raster_100m_allSpeciesAreas.tif")
lead_htop_rast_allSpeciesAreas = terra::rast("/media/seamus/Ubuntu 22_04 LTS amd64/mosaics/lead_htop_raster_100m_allSpeciesAreas.tif")
...
writeRaster(elev_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/elev_raster_100m_allSpeciesAreas.tif", overwrite=TRUE)
writeRaster(slope_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/slope_raster_100m_allSpeciesAreas.tif", overwrite=TRUE)
writeRaster(asp_cos_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_cos_raster_100m_allSpeciesAreas.tif", overwrite=TRUE)
writeRaster(asp_sin_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas.tif", overwrite=TRUE)
writeRaster(lead_htop_rast_allSpeciesAreas, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas.tif", overwrite=TRUE)
```

```{r, fig.show='hold', out.width="33%", echo=FALSE}
elev_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/elev_raster_100m_allSpeciesAreas.tif")
lead_htop_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas.tif")
slope_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/slope_raster_100m_allSpeciesAreas.tif")
asp_cos_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_cos_raster_100m_allSpeciesAreas.tif")
asp_sin_rast_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/unmasked-covariates/dem-based/asp_sin_raster_100m_allSpeciesAreas.tif")
terra::plot(elev_rast_allSpeciesAreas)
...
writeRaster(lead_htop_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/lead_htop_rast_allSpeciesAreas_masked.tif", overwrite=TRUE)
writeRaster(elev_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/elev_rast_allSpeciesAreas_masked.tif", overwrite=TRUE)
writeRaster(slope_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/slope_rast_allSpeciesAreas_masked.tif", overwrite=TRUE)
writeRaster(asp_cos_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_cos_rast_allSpeciesAreas_masked.tif", overwrite=TRUE)
writeRaster(asp_sin_rast_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_sin_rast_allSpeciesAreas_masked.tif", overwrite=TRUE)
writeRaster(species_class_raster_allSpeciesAreas_masked, filename = "/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/species_class_rast_allSpeciesAreas_masked,tif", overwrite=TRUE)
```

```{r, fig.show='hold', out.width="33%", echo=FALSE}
lead_htop_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/lead_htop_rast_allSpeciesAreas_masked.tif")
elev_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/elev_rast_allSpeciesAreas_masked.tif")
slope_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/slope_rast_allSpeciesAreas_masked.tif")
asp_cos_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_cos_rast_allSpeciesAreas_masked.tif")
asp_sin_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/asp_sin_rast_allSpeciesAreas_masked.tif")
species_class_rast_allSpeciesAreas_masked = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/inputs/masked-covariates/dem-based/species_class_rast_allSpeciesAreas_masked.tif")
```
...
writeRaster(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, overwrite=TRUE,
  filename = "/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas.tif")
...
```{r, fig.show='hold', out.width="50%", echo=FALSE}
wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas = terra::rast("/media/seamus/128GB_WORKD/data/raster/tcc/outputs/wsvha/bootstrapped/wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas.tif")
plot(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, main="WSVHA for all-Species Operating Areas: Random Forest", cex.main=0.8, maxpixels=22000000)
hist(wsvha_model1_randomForest_bootstrapped_demBased_100m_allSpeciesAreas, main="WSVHA for all-Species Operating Areas: Random Forest", cex.main=0.8, maxpixels=22000000) 
```
