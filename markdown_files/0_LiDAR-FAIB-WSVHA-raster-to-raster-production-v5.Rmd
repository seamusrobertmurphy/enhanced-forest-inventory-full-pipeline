...
```{r, eval=FALSE}
###watch out for small/large font changes###
...
filez_be_ahbau = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/ahbau/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_ahbau = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/ahbau/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_be_bells = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/bells/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_bells = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/bells/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_be_big_valley = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/big_valley/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_big_valley = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/big_valley/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_be_cariboo_lake = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/cariboo_lake/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_cariboo_lake = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/cariboo_lake/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_be_charleson_marvincreek = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/charleson_marvincreek/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_charleson_marvincreek = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/charleson_marvincreek/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_be_dash = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/dash/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_dash = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/dash/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_be_hawks_creek = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/hawks_creek/BareEarth", full.names = T, all.files = FALSE, pattern = '.tif$') 
filez_vh_hawks_creek = list.files("/media/seamus/Ubuntu 22_04 LTS amd64/mosaicz/hawks_creek/VegHt", full.names = T, all.files = FALSE, pattern = '.tif$') 
...
terra::plot(lead_htop_raster_gaspard, main = 'CHM Raw (1m res)')
