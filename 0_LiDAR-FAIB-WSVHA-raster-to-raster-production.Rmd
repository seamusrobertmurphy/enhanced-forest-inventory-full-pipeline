...
names(stemsha_L_rast_20cell_quesnel) = "stemsha_L"
names(lead_htop_rast_20cell_quesnel) = "lead_htop"
...
names(stemsha_L_rast_20cell_gaspard) = "stemsha_L"
names(lead_htop_rast_20cell_gaspard) = "lead_htop"
...
print(as_tibble(faib_psp))

faib_psp = na.omit(faib_psp)
psych::describe(faib_psp)

#################3
stemsha_L_raster = na.omit(stemsha_L_raster)
stemsha_L_raster_df = as.data.frame(rasterToPoints(stemsha_L_raster))
dist.fun = stats::approxfun(density(stemsha_L_raster_df$layer))
summary(faib_psp)
